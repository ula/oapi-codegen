...
directory does a lot of that for you. You would run it like so:
    ...
    go install github.com/ula/oapi-codegen/v2/cmd/oapi-codegen@latest
...
let's call it `github.com/ula/some-package`. You need to tell `oapi-codegen` that
`some_spec.yaml` corresponds to this package, and you would do it by specifying
this command line argument:

    -import-mapping=./some_spec.yaml:github.com/ula/some-package

This tells us that in order to resolve references generated from `some_spec.yaml` we
need to import `github.com/ula/some-package`. You may specify multiple mappings
...
output-options:
  user-templates:
    ...
    client-with-responses.tmpl: https://raw.githubusercontent.com/ula/oapi-codegen/7b010099dcf1192b3bfaa3898b5f375bb9590ddf/pkg/codegen/templates/client-with-responses.tmpl
    # using raw.githubusercontent.com with a tag
    client-with-responses.tmpl: https://raw.githubusercontent.com/ula/oapi-codegen/v1.12.4/pkg/codegen/templates/client-with-responses.tmpl
    # using raw.githubusercontent.com with a branch
    client-with-responses.tmpl: https://raw.githubusercontent.com/ula/oapi-codegen/master/pkg/codegen/templates/client-with-responses.tmpl
